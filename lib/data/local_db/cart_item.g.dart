...
extension CartItemByIndex on IsarCollection<CartItem> {
  Future<CartItem?> getByTitle(String title) {
    return getByIndex(r'title', [title]);
  }

  CartItem? getByTitleSync(String title) {
  ...
  Future<List<CartItem?>> getAllByTitle(List<String> titleValues) {
    final values = titleValues.map((e) => [e]).toList();
    return getAllByIndex(r'title', values);
  }

  List<CartItem?> getAllByTitleSync(List<String> titleValues) {
    final values = titleValues.map((e) => [e]).toList();
  ...
  Future<Id> putByTitle(CartItem object) {
    return putByIndex(r'title', object);
  }

  Id putByTitleSync(CartItem object, {bool saveLinks = true}) {
    return putByIndexSync(r'title', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByTitle(List<CartItem> objects) {
    return putAllByIndex(r'title', objects);
  }

  List<Id> putAllByTitleSync(List<CartItem> objects, {bool saveLinks = true}) {
...
extension CartItemQueryWhere on QueryBuilder<CartItem, CartItem, QWhereClause> {
  ...
  QueryBuilder<CartItem, CartItem, QAfterWhereClause> titleEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterWhereClause> titleNotEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension CartItemQueryFilter
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> countEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> countGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> countLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> countBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CartItemQuerySortBy on QueryBuilder<CartItem, CartItem, QSortBy> {
  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'count', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQuerySortThenBy
  ...
  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'count', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'count', Sort.desc);
    });
  }
...
extension CartItemQueryWhereDistinct
  ...
  QueryBuilder<CartItem, CartItem, QDistinct> distinctByCount() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQueryProperty
  ...
  QueryBuilder<CartItem, int, QQueryOperations> countProperty() {
    return QueryBuilder.apply(this, (query) {
